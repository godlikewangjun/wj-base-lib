...
object PermissionConstants {
    ...
    private val GROUP_PHONE = arrayOf(permission.READ_PHONE_STATE, permission.CALL_PHONE, permission.READ_CALL_LOG, permission.WRITE_CALL_LOG, permission.ADD_VOICEMAIL, permission.USE_SIP, permission.PROCESS_OUTGOING_CALLS)
    private val PHONE_STATE = arrayOf(permission.READ_PHONE_STATE)
    ...
    fun getPermissions(@Permission permission: String): Array<String> {
        when (permission) {
            ...
            READ_PHONE_STATE -> return PHONE_STATE
