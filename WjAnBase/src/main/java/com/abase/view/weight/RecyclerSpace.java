...
public class RecyclerSpace extends RecyclerView.ItemDecoration {
     ...
     * Divider的构建者
     */
    public static RecyclerSpace.Builder builder() {
        return new RecyclerSpace.Builder();
    }

    public static class Builder {

        private final RecyclerSpace divider;

        Builder() {
            divider = new RecyclerSpace();
        }

        /**
         * 设置线宽
         */
        public RecyclerSpace.Builder width(int lineWidth) {
         ...
         * 设置线高
         */
        public RecyclerSpace.Builder height(int lineHeight) {
         ...
         * 同时设置线宽、线高
         */
        public RecyclerSpace.Builder widthAndHeight(int lineSize) {
         ...
         * 设置线颜色，和drawable二选一
         */
        public RecyclerSpace.Builder color(int lineColor) {
         ...
         * 设置线背景，和color二选一
         */
        public RecyclerSpace.Builder drawable(Drawable dividerDrawable) {
         ...
         * 设置头的数量
         */
        public RecyclerSpace.Builder headerCount(int headerCount) {
         ...
         * 设置尾的数量
         */
        public RecyclerSpace.Builder footerCount(int footerCount) {
