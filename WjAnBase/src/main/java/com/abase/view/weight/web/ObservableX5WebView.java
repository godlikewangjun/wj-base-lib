 ...
 * @date 2018/11/14/014
 */
public class ObservableX5WebView extends X5WebView implements Scrollable {
    ...
    public ObservableX5WebView(Context context) {
        super(context);
    }

    public ObservableX5WebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    class SavedState extends BaseSavedState {
        ...
        public final Creator<ObservableX5WebView.SavedState> CREATOR
            ...
            public ObservableX5WebView.SavedState createFromParcel(Parcel in) {
                return new ObservableX5WebView.SavedState(in);
            }

            @Override
            public ObservableX5WebView.SavedState[] newArray(int size) {
                return new ObservableX5WebView.SavedState[size];
            }
        };
    }
}
