...
public final class PermissionUtils {
    ...
    private static WeakReference<Context> mApp = null;
    ...
    public static List<String> getPermissions() {
        return getPermissions(mApp.get().getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = mApp.get().getPackageManager();
        try {
            String[] per = pm.getPackageInfo(packageName, PackageManager.GET_PERMISSIONS)
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(mApp.get(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + mApp.get().getPackageName()));
    ...
    public static PermissionUtils permission(Context mContext, @PermissionConstants.Permission final String...
        ...
        mApp = new WeakReference<>(mContext);
