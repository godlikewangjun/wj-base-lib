...
public class AbImageUtil {
	...
	public static Bitmap getBitmap(File file) {
		...
		try {
			resizeBmp = BitmapFactory.decodeFile(file.getAbsolutePath());
		} catch (Exception e) {
			e.printStackTrace();
		}
		return resizeBmp;
	 ...
	 * @return Bitmap 新图片
	 */
	public static Bitmap getScaleBitmap(File file, float scalef) {
		...
		int srcWidth = opts.outWidth;
		int srcHeight = opts.outHeight;
		int[] size = resizeToMaxSize(srcWidth, srcHeight, (int)(srcWidth*scalef), (int)(srcHeight*scalef));
...
//			}
	...
	/**毛玻璃效果*/
	@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
	public static Bitmap maoBoLi(Context context, Bitmap sentBitmap, int radius){
		Bitmap bitmap;
	...
	public static void setTextViewDrableLeft(Context activity,TextView tv,int wh,int drableRid){
		Drawable drawable = activity.getResources().getDrawable(drableRid);
		wh=AbViewUtil.dp2px(activity, wh);
		drawable.setBounds(0, 0, wh, wh);
		tv.setCompoundDrawables(drawable, null, null, null);
	}
	/**设置textview的drableleft*/
	public static void setTextViewDrableTop(Context activity,TextView tv,int wh,int drableRid){
		Drawable drawable = activity.getResources().getDrawable(drableRid);
		wh=AbViewUtil.dp2px(activity, wh);
		drawable.setBounds(0, 0, wh, wh);
	...
	/**设置textview的drableleft*/
	public static void setBackground(Context activity,View view,int wh,int drableRid){
		Drawable drawable = activity.getResources().getDrawable(drableRid);
		wh=AbViewUtil.dp2px(activity, wh);
		drawable.setBounds(0, 0, wh, wh);
