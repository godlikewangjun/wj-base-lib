...
public class AbViewUtil {
	public static float defaultSancle=2.0f;//默认屏幕的密度
     ...
     * @return
     */
    public static int dp2px(Context context,float scale,float dp) { 
        return (int) (dp * scale + 0.5f); 
    } 
	/**
	 * 描述：根据屏幕大小缩放.
    ...
    public static void scaleView(Context context,View view){
        if (view instanceof TextView){
            TextView textView = (TextView) view;
            setTextSize(textView, dp2px(context, textView.getTextSize()));
        }
